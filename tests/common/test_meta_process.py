...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_aws = mock_aws() #previously self.mock_s3 = mock_s3()
        self.mock_aws.start() #previously self.mock_s3.start()
        ...
        self.s3 = boto3.resource(service_name='s3', endpoint_url=self.s3_endpoint_url, region_name='eu-central-1')
    ...
    def test_update_meta_file_to_meta_file(self):
        """
    ...
    def test_update_meta_file_empty_date_list(self):
        ...
        with self.assertLogs() as logm:
            ...
            # Log test after method exeution 
    ...
    def test_update_meta_file_meta_file_ok(self):
        """
        Tests the update_meta_file method 
        when there already is a meta file
        """        
        # Expected results 
